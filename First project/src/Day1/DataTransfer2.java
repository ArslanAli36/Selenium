...
public class DataTransfer2 {
		  ...
		  public String[] readExcel(String filePath, String fileName, String sheetName) throws IOException{
             ...
             //   String j_username = formatter.formatCellValue(cell);
		      ...
		      DataTransfer2 objExcelFile = new DataTransfer2();
		      ...
		      driver.findElement(By.id("input_11_postal")).sendKeys(data[0]);
		      driver.findElement(By.id("input_6_area")).sendKeys(data[1]);
		      driver.findElement(By.id("input_6_phone")).sendKeys(data[2]);
		      driver.findElement(By.id("lite_mode_12")).sendKeys(data[3]);
