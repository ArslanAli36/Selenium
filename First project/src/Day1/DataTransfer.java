...
public class DataTransfer {
		  ...
		  public String[] readExcel(String filePath, String fileName, String sheetName) throws IOException{
		    ...
		    // Main function is calling readExcel function to read data from excel file
		     ...
		     String data[]= objExcelFile.readExcel(filePath, "user data.xlsx", "Sheet1");
		 
		      driver.findElement(By.id("first_4")).sendKeys(data[0]);
		      driver.findElement(By.id("last_4")).sendKeys(data[1]);
		      driver.findElement(By.id("input_10")).sendKeys(data[2]);
		      driver.findElement(By.id("input_11_addr_line1")).sendKeys(data[3]);
		      driver.findElement(By.id("input_11_addr_line2")).sendKeys(data[4]);
		      driver.findElement(By.id("input_11_city")).sendKeys(data[5]);
		      driver.findElement(By.id("input_11_state")).sendKeys(data[6]);
		   ...
		   //   driver.findElement(By.id("lite_mode_12")).sendKeys();
		      ...
		      driver.findElement(By.id("input_5")).sendKeys(data[7]);
		      driver.findElement(By.id("input_7")).sendKeys(data[8]);
		      driver.findElement(By.id("input_8")).sendKeys(data[9]);
